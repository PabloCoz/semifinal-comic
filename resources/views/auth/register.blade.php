<div class="w-full">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <input id="username" class="block mt-1 w-full rounded-full border focus:border-black ring-0 focus:ring-black"
        ...
        <div class="mt-4">
            <label class="font-bold text-sm tracking-wider">Confirmar contraseña</label>
